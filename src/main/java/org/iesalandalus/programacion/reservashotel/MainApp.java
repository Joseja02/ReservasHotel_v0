        ...
        for (int i = 0; i < habitacionesTipoSolicitado.length && !tipoHabitacionEncontrada; i++) {
            ...
            if (habitacionesTipoSolicitado[i] != null) {
                ...
                if (numElementos == 0) {
                    ...
                    // quiere decir que estÃ¡ disponible.
                    ...
                    // (la reserva de la posiciÃ³n 0), quiere decir que la habitaciÃ³n estÃ¡ disponible en las fechas indicadas.
                    ...
                    //Recorremos el array de reservas futuras para ver si las fechas solicitadas estÃ¡n algÃºn hueco existente entre las fechas reservadas
                    if (!tipoHabitacionEncontrada) {
